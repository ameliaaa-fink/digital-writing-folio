# Project Planning, Iterations & Folio Sketches
## Week 6
## Goal Setting
_Reflect on what you need to do next in your concept development process. Define 3 key tasks, and give yourself a date for completing 
them._\
**1. Write full outline of narrative & diaogue.** (Week 7)\
I want to have a completed outline, likely formatted in Miro, of the story's development through the messages with Kyle. I expect that 
this will change, even as I complete the coding for it, but I just want to know where the plot is headed before I dive into it. I think 
it's important to have the key points so that I can focus on hitting each one as I go along, in order to avoid the narrative wandering 
away from me. Especially since I've already found that it's very easy for it to get away from me when I fixate on a particular execution 
of the coding.\

**2. Have a working 'desktop' code by presentations**. (Week 7/8)\
   For our presentations, we will need to have four pages finished and mostly polished to share as an early prototpye of the work. For 
this, I hope that I will have figured out enough of the code to have a pretty cut-and-paste strucutre of the code that I can reuse for 
most of my project. How I plan to code _Messages with Kyle_ (working name) is to have a background, one that I will probably work into 
photoshop, like I did for the messages in my coding playground, and then have text and cut-out images pasted onto the page. I'm unsure 
at this point how some specific functions of this will work; for example, how I will have a textbox for which the 'player' can type into, 
that forces something to be typed out, or how I will have a streamline of messages with Kyle that flow one after another like a messenger 
app realistically works. However, these are functions I have seen successfully executed by some of the works we have looked at, so I don't 
expect it to be too difficult?\
   
**3. Figure out the functions of an 'error' message pop-up.** (Week 8/9)\
      This is probably the aspect of my project that I'm most unsure of. It's something I haven't really seen in many of the works we've 
previously studied and it's the most 'game-like' part of the code I feel like. I'm somewhat concerned but not too much, because I have been
seeing some similar things in the early iterations of my classmates' projects, so I can seek their support if I struggle too much with it.
